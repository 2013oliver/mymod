...
public class ManySnowBall extends SnowballItem {
    public ManySnowBall(Properties p_43140_) {
        super(p_43140_);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level p_43142_, Player p_43143_, InteractionHand p_43144_) {
        ...
        if (!p_43142_.isClientSide) {
            ...
            Snowball snowball1 = new Snowball(p_43142_, p_43143_);
            Snowball snowball2 = new Snowball(p_43142_, p_43143_);
            Snowball snowball3 = new Snowball(p_43142_, p_43143_);
            Snowball snowball4 = new Snowball(p_43142_, p_43143_);
            Snowball snowball5 = new Snowball(p_43142_, p_43143_);
            Snowball snowball6 = new Snowball(p_43142_, p_43143_);
            Snowball snowball7 = new Snowball(p_43142_, p_43143_);
            Snowball snowball8 = new Snowball(p_43142_, p_43143_);
